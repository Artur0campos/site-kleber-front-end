const STRAPI_URL = process.env.NEXT_PUBLIC_STRAPI_URL || "https://n8n-artur-strapi.wlpas2.easypanel.host/";
...
export async function getPosts() {
  try {
    const res = await fetch(
      `${STRAPI_URL}/api/posts?populate=Imagem&sort=publishedAt:desc`,
      {
